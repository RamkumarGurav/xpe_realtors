...
$config['sess_save_path'] = BASEPATH . 'application/cache/' . date('d-m-Y') . '/';
...
$config['csrf_exclude_uris'] = array("secureRegions/(:any)", "secureRegions/(:any)/(:any)", "secureRegions/(:any)/(:any)/(:any)", "secureRegions/%");
