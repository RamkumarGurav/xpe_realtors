...
<script>
  ...
  function load_more_property() {
    ...
    var property_type_id = $("#property_type_id").value;
    var property_sub_type_id = $("#property_sub_type_id").value;
    var bhk_type_id = $("#bhk_type_id").value;
    var door_facing_type_id = $("#door_facing_type_id").value;
    var plot_facing_type_id = $("#plot_facing_type_id").value;
    var gated_community_type_id = $("#gated_community_type_id").value;
    var sale_type_id = $("#sale_type_id").value;
    ...
    $.ajax({
      ...
      url: mainsite + "/load_more_property",
      ...
      success: function (result) {
        ...
        if (result == 'NO') {
          ...
          result = '<div class="alert alert-danger" role="alert">No More Properties To Display</div>';

          $(".property_list_end").html(result);
        } else {
