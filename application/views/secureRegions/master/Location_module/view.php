                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $location_data->state_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">City</strong>
                                            <?php echo $location_data->city_name ?>
                                        </td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $location_data->pincode ?>
                                        </td>
                                        <td>
                                            <strong class="full">Is Display?</strong>
                                            <?php if ($location_data->is_display == 1) { ?> Yes <i
                                        ...
                                        <td>
                                            ...
                                            <?php echo date("d-m-Y h:i:s A", strtotime($location_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php echo $location_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php if (!empty($location_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($location_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($location_data->updated_by_name)) {
                                                echo $location_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($location_data->status == 1) { ?> Active <i
                                                    class="fas fa-check btn-success btn-sm "></i>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><strong class="full">Added On</strong>
                                            <?php echo date("d-m-Y h:i:s A", strtotime($location_data->added_on)) ?></td>
                                        <td><strong class="full">Added By</strong>
                                            <?php echo $location_data->added_by_name ?></td>
