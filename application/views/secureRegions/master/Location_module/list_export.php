...
$filename = "Location-List-" . date('d-m-Y') . ".xls";
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                ...
                <th style="background-color:#999" width="*">Location</th>
        ...
        <tbody>
            ...
            if (!empty($location_data)) { //print_r($ptype_list);
                foreach ($location_data as $item) {
                    //if($item->in_hand > 0 || $item->total_purchase > 0 || $item->total_sold > 0 || $item->total_returned > 0 || $item->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?php echo $item->location_name; ?></td>
