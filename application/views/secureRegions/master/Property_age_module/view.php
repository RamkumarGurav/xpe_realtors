...
if (!empty($property_age_data)) {
    // $record_action = "Update";
    // $id = $property_age_data->id;
    // $name = $property_age_data->name;
    // $status = $property_age_data->status;
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $property_age_data->name ?></h3>
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/edit/<?php echo $property_age_data->id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $property_age_data->id ?>
                                        </td>
                                        <td>
                                            <strong class="full">Property Age</strong>
                                            <?php echo $property_age_data->name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added On</strong>
                                            <?php echo date("d-m-Y h:i:s A", strtotime($property_age_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php echo $property_age_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php if (!empty($property_age_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($property_age_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($property_age_data->updated_by_name)) {
                                                echo $property_age_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($property_age_data->status == 1) { ?> Active <i
