				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a
								...
								List</a></li>
						<?php if (!empty($property_age_data)) { ?>
							<li class="breadcrumb-item"><a
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="form-group col-md-6 row">
									<label for="inputEmail3" class="col-sm-4 label_content text-right mt-2">Property Age </label>
									<div class="col-sm-6">
										<input type="text" class="form-control form-control-sm" required id="name" name="name"
											value="<?php echo $name ?>" placeholder="Property Age">
