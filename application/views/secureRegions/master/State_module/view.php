                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $state_data->state_code ?>
                                        </td>

                                        <td>
                                            <strong class="full">Is Display?</strong>
                                            <?php if ($state_data->is_display == 1) { ?> Yes <i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($state_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($state_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($state_data->updated_by_name)) {
                                                echo $state_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($state_data->status == 1) { ?> Active <i
                                                    class="fas fa-check btn-success btn-sm "></i>
