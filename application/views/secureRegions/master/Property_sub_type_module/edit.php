...
if (!empty($property_sub_type_data)) {
	...
	$property_type_id = $property_sub_type_data->property_type_id;
						...
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Property type
								...
								<div class="col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Property Sub Type Name
										<span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" required id="name" name="name"
											value="<?php echo $name ?>" placeholder="Property Sub Type Name">
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
