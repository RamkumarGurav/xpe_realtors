										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
													...
													<option value='ft.name' <?php if ($field_name == 'ft.company_unique_name') {
														echo 'selected';
													} ?>>Company Unique Name</option>
													<option value='ft.company_name' <?php if ($field_name == 'ft.company_name') {
														echo 'selected';
													} ?>>Company Name</option>
													...
													<option value='ft.mobile_no' <?php if ($field_name == 'ft.mobile_no') {
														...
														Mobile No.</option>
													<option value='ft.gst_no' <?php if ($field_name == 'ft.gst_no') {
														echo 'selected';
													} ?>>GST No.
													</option>
												</select>
