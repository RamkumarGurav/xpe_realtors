            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $company_profile_data->company_unique_name ?></h3>
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/edit/<?php echo $company_profile_data->id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $company_profile_data->id ?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <span class="pip">
                                                    <img class="imageThumb" src="<?php echo IMAGE_ADMIN ?>no_image.jpg" />
                                                </span>
                                            <?php } ?>
                                        </td>
                                        <td colspan="2">
